...
namespace BREPipelineFramework.UnitTests
{
    ...
    public class ContextMetaInstructionsTest
    {
        ...
        public void Test_Set_XPath_Value()
        {
            ...
            string XPathQuery = "boolean(/*[local-name()='MessageInfo']/*[local-name()='ContextInfo']/*[local-name()='Property'][@Name='From'][@Promoted='true'][@Namespace='http://schemas.microsoft.com/BizTalk/2003/smtp-properties'][@Value='Test_Set_BTS_DestinationParty'])";
            string ExpectedValue = "True";
        ...
        public void Test_Set_XPath_Namespace()
        {
            ...
            string XPathQuery = "boolean(/*[local-name()='MessageInfo']/*[local-name()='ContextInfo']/*[local-name()='Property'][@Name='From'][@Promoted='true'][@Namespace='http://schemas.microsoft.com/BizTalk/2003/smtp-properties'][@Value='http://www.w3.org/2001/XMLSchema-instance'])";
            string ExpectedValue = "True";
